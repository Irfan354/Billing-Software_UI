...
const CategoryList=()=>{
    const {categories, setCategories} = useContext(AppContext); //pull the data
    const [searchTerm, setSearchTerm] = useState('');

    //to filter the keywords in search bar we use this method 
    const filteredCategories = categories.filter(category => 
        category.name.toLowerCase().includes(searchTerm.toLowerCase())
    );

    //function method for delete operation --> delete the category List
